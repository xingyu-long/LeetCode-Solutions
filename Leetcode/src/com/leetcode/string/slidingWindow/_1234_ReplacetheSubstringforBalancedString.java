...
public class _1234_ReplacetheSubstringforBalancedString {
    ...
    public static void main(String[] args) {
        _1234_ReplacetheSubstringforBalancedString balancedString = new _1234_ReplacetheSubstringforBalancedString();
        String s = "QWER";
        System.out.print(balancedString.balancedString(s));
    }
}